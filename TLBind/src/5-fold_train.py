...
def main(args):
    ...
    #device = 'cpu'
    effort = 'BA_EL_' + str(batch_size) + '_' + str(lr) + '_' + str(latent_dim) + '_' + str(weight_decay) + '_fold' + str(fold)

    # Load data and make the loaders
    idx_dict_train, train_BA, train_MS, train_MR = get_dataset("../folds/train_" + str(fold) + ".csv")
    idx_dict_valid, valid_BA, valid_MS, valid_MR = get_dataset("../folds/val_" + str(fold) + ".csv")
